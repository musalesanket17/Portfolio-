    ...
    <div className={styles.rootCont} id="contact">
      ...
      <Form onSubmit={handleOnSubmit}>
        ...
        <div className={styles.iconsCont}>
          <a href="sanketmusale96847@gmail.com">
            <AiOutlineMail className={styles.emailicon} />
          </a>
          <a
            href="https://www.linkedin.com/in/sanket-musale-642b9120b/"
            target="_blank"
            rel="noreferrer"
          >
            <AiFillLinkedin className={styles.linkedInIcon} />
          </a>
          <a href="https://github.com/musalesanket17" rel="noreferrer" target="_blank">
            <AiOutlineGithub className={styles.gitIcon} />
          </a>
        </div>
        <p className={styles.text}>Phone: +91 8999116815</p>{" "}
        <p className={styles.text}>Email: sanketmusale96847@gmail.com</p>
      </Fade>
    </div>
  )
}
